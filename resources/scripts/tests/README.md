...
```bash
python3 -m unittest \
  resources.scripts.tests.test_pdf_tool_smoke \
  resources.scripts.tests.test_xlsx_tool_smoke \
  resources.scripts.tests.test_docx_tool_smoke \
  resources.scripts.tests.test_pptx_tool_smoke \
  resources.scripts.tests.test_img_tool_smoke \
  resources.scripts.tests.test_ical_tool_smoke \
  resources.scripts.tests.test_doc_diff_smoke \
  resources.scripts.tests.test_markitdown_smoke
```
...
```bash
python3 -m unittest resources.scripts.tests.test_xlsx_tool_smoke
```
